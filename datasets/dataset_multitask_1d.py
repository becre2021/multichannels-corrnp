...
#         if tasktype == 'sin3_ind':
#             self.f = sin_3channels_ind
#             self.nchannels = 3
        
#         if tasktype == 'sin3_dep':
...
#             self.nchannels = 4
            ...
            #kernel =   
            #kernel_list = []
            #kernel_list = [Matern(nu=0.5,input_dims=1),Matern(nu=1.5,input_dims=1),Matern(nu=2.5,input_dims=1)]
            
            #self.f = LMC(kernel_list=kernel_list,output_dims=self.nchannels, input_dims=1) 
            
#             kernel_list = [Matern(nu=0.5,sigma=0.9, l=0.05,input_dims=1),
#                            Matern(nu=1.5,sigma=0.9, l=0.25,input_dims=1),
#                            Matern(nu=2.5,sigma=0.9, l=1,input_dims=1)]            
...
#     f1 = lambda x : 1*np.sin(3.1*(x+ phase          + phase0 ) ) 
...
#     #dep
#     f1 = lambda x : 1*(1+mag)*np.sin( (3.1 + phase)*(x            + phase0 ) ) 
