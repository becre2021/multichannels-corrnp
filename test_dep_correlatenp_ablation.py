...
from test_dep_correlatenp import DCGP_Convnp
...
class DCGPAB_Convnp(DCGP_Convnp):
    def __init__(self,in_dims: int = 1,out_dims:int = 1,
                      num_channels: int=3,
                      num_mixtures: int=3,
                      cnntype='shallow',
                      num_postsamples=10,
                      init_lengthscale=1.0):
        super(DCGPAB_Convnp,self).__init__(in_dims,
                                         out_dims, 
                                         num_channels,
                                         cnntype,
                                         num_postsamples,
...
#                                             useweightnet = True)
        ...
        self.gpsampler =  Spikeslab_GPsampler_ablation( in_dims=in_dims,
                                                        out_dims=out_dims,
                                                        num_channels=num_channels, 
